    ...
    <main>
        <section class="px-28 py-14">
            <div class="max-w-4xl mx-auto bg-white text-black p-8 rounded-lg shadow-lg border-2 border-[#28B8FF]">
                ...
                <form action="/manage-education/create" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                        <label for="nama_course" class="block font-medium text-gray-700">Nama Course</label>
                        <input required type="text" name="nama_course" id="nama_course" class="mt-1 px-2 py-1.5 block w-full border-gray-300 rounded-md shadow-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    </div>
                    <div class="mb-4">
                        <label for="gambar_course" class="block font-medium text-gray-700">Gambar Course</label>
                        <input required type="file" name="gambar_course" id="gambar_course" accept=".jpg, .png, .jpeg" class="mt-1 px-2 py-1.5 block w-full border-gray-300 rounded-md shadow-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    </div>
                    <div class="mb-4">
                        <label for="deskripsi_course" class="block font-medium text-gray-700">Deskripsi Course</label>
                        <textarea required name="deskripsi_course" id="deskripsi_course" rows="4" class="mt-1 px-2 py-1.5 block w-full border-gray-300 rounded-md shadow-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                    </div>
