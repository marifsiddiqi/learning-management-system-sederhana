    ...
    <main>
        <section class="px-28 pt-6">
            <div class="max-w-4xl mx-auto bg-white text-black p-8 rounded-lg shadow-lg border-2 border-[#28B8FF]">
                <h2 class="text-2xl font-bold mb-6">Create Materi</h2>
                <form action="/manage-materi/create/{{ $id_course }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                        <label for="nama_materi" class="block font-medium text-gray-700">Nama Materi</label>
                        <input required type="text" name="nama_materi" id="nama_materi"
                    ...
                    <div class="mb-4">
                        ...
                        <input required type="file" name="gambar_materi" id="gambar_materi" accept=".jpg, .png, .jpeg" class="mt-1 px-2 py-1.5 block w-full border-gray-300 rounded-md shadow-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    </div>
                    <div class="mb-4">
                        ...
                        <textarea required name="isi_materi" id="isi_materi" rows="4"
                            class="mt-1 px-2 py-1.5 block w-full border-gray-300 rounded-md shadow-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                    </div>
